  ...
  items: [
    {
      ...
      desc: 'Point at an Azure Architecture Center pattern, an AWS reference, or your own diagram — get a working, deployed implementation.',
  ...
  items: [
    {
      ...
      desc: 'Every task runs in an ephemeral sandbox — separate identity, network, and lifecycle. Experiments and failures never reach your production estate.',
    },
    {
      icon: 'clock',
